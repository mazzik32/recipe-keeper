    ...
    return (
        <View>
            ...
            <View className="flex-row flex-wrap gap-2 mb-3">
                {value.map(tag => (
                    <View key={tag.id} className="bg-peach-100 dark:bg-dark-peach-subtle dark:bg-dark-peach-subtle flex-row items-center px-3 py-1.5 rounded-full">
            ...
            <TouchableOpacity
                ...
                className="border border-warm-gray-200 dark:border-dark-border dark:border-dark-border rounded-xl px-4 py-3 flex-row justify-between items-center bg-white dark:bg-dark-card dark:bg-dark-card"
            >
                <Text className="text-warm-gray-500 dark:text-dark-muted dark:text-dark-muted">{t.tags?.addTag || "+ Add Tag"}</Text>
            ...
            >
                <KeyboardAvoidingView
                    ...
                    className="flex-1 bg-cream dark:bg-dark-bg dark:bg-dark-bg"
                >
                    {/* Modal Header */}
                    <View className="flex-row items-center justify-between px-4 py-4 bg-white dark:bg-dark-card dark:bg-dark-card border-b border-warm-gray-100 dark:border-dark-border dark:border-dark-border">
                        <Text className="font-playfair text-xl text-warm-gray-700 dark:text-dark-text dark:text-dark-text">{t.tags?.tags || "Tags"}</Text>
                    ...
                    {/* Search / Create Input */}
                    <View className="p-4 bg-white dark:bg-dark-card dark:bg-dark-card border-b border-warm-gray-100 dark:border-dark-border dark:border-dark-border">
                        <TextInput
                            value={searchText}
                            onChangeText={setSearchText}
                            placeholder={t.tags?.newTagName || "New tag name..."}
                            className="bg-warm-gray-50 dark:bg-dark-elevated dark:bg-dark-elevated px-4 py-3 rounded-xl text-warm-gray-700 dark:text-dark-text dark:text-dark-text text-base"
                            autoFocus
                            autoCapitalize="none"
                            autoCorrect={false}
                        />
                        ...
                        <ScrollView className="flex-1 px-4 py-2" keyboardShouldPersistTaps="handled">
                            ...
                            {showCreateButton && (
                                <TouchableOpacity
                                    ...
                                    disabled={creating}
                                    className="flex-row items-center py-4 border-b border-warm-gray-100 dark:border-dark-border dark:border-dark-border"
                                >
                                    {creating ? (
                                        <ActivityIndicator size="small" color="#eb6e3e" className="mr-3" />
                                    ) : (
                                        <View className="w-6 h-6 rounded bg-peach-100 dark:bg-dark-peach-subtle dark:bg-dark-peach-subtle items-center justify-center mr-3">
                            ...
                            {!loading && allTags.length === 0 && !searchText && (
                                <View className="py-8 items-center">
                                    ...
                                    <Text className="text-warm-gray-500 dark:text-dark-muted dark:text-dark-muted text-center px-8">
                            ...
                            {filteredTags.map(tag => {
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        className="flex-row items-center justify-between py-4 border-b border-warm-gray-100 dark:border-dark-border dark:border-dark-border"
                                    >
