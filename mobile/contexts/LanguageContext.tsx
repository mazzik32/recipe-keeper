...
export const en = {
    ...
    auth: {
        ...
        createAccountDesc: "Start preserving your family recipes today",
        displayNamePlaceholder: "Display Name (e.g. Anna)",
        continueApp: "Continue using App",
        backToLogin: "Back to Login",
        alreadyHaveAccount: "Already have an account?",
        checkEmail: "Check your email",
        checkEmailDesc: "We have sent you a confirmation link. Please check your inbox (and spam folder) and click the link to activate your account.",
    },
    nav: {
        home: "Home",
        search: "Search",
    ...
    creditGate: {
        ...
        freeScansDesc: "You've used all 5 of your free recipe scans! Create a free account now to permanently save your scanned recipes and get more credits.",
        outOfCreditsDesc: "You have no credits left to scan new recipes. Get more credits in your settings.",
...
export const de: Translations = {
    ...
    auth: {
        ...
        pendingVerification: "E-Mail-Bestätigung ausstehend",
        createAccountDesc: "Beginne noch heute, deine Familienrezepte zu bewahren",
        displayNamePlaceholder: "Anzeigename (z.B. Anna)",
        continueApp: "Weiter zur App",
        backToLogin: "Zurück zum Login",
        alreadyHaveAccount: "Hast du schon ein Konto?",
        checkEmail: "E-Mail bestätigen",
        checkEmailDesc: "Wir haben dir einen Bestätigungslink gesendet. Bitte überprüfe deinen Posteingang (und Spam-Ordner) und klicke auf den Link, um dein Konto zu aktivieren.",
    },
    nav: {
        home: "Start",
        search: "Suchen",
    ...
    creditGate: {
        freeScansUsedUp: "Gratis Scans aufgebraucht",
        outOfCredits: "Keine Credits mehr",
        freeScansDesc: "Du hast alle 5 deiner kostenlosen Rezept-Scans verbraucht! Erstelle jetzt ein kostenloses Konto, um deine gescannten Rezepte dauerhaft zu speichern und weitere Credits zu erhalten.",
        outOfCreditsDesc: "Du hast keine Credits mehr übrig, um neue Rezepte zu scannen. Hole dir in den Einstellungen weitere Credits.",
        createFreeAccount: "Konto erstellen (Gratis)",
        getMoreCredits: "Credits aufladen",
    },
    onboarding: {
